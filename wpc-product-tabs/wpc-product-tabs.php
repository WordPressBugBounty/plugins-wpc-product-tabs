        ...
        if ( ! class_exists( 'WPCleverWoost' ) && class_exists( 'WC_Product' ) ) {
            class WPCleverWoost {
                ...
                function __construct() {
                    self::$tabs = (array) get_option( 'woost_tabs', [] );
                ...
                function init() {
                    // load text-domain
                    load_plugin_textdomain( 'wpc-product-tabs', false, basename( WOOST_DIR ) . '/languages/' );
                    ...
                    <div class="wpclever_settings_page wrap">
                        <div class="wpclever_settings_page_header">
                            ...
                            <div class="wpclever_settings_page_header_text">
                                <div class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Product Tabs', 'wpc-product-tabs' ) . ' ' . esc_html( WOOST_VERSION ) . ' ' . ( defined( 'WOOST_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-product-tabs' ) . '</span>' : '' ); ?></div>
